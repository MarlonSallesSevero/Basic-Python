...
- Qualquer tipo de dado: Mão possuem tipo de fafo fixo; Ou seja, podemos colocar qualquer tipo de dado;
...
# OBS: Por padrâo, o slit separa os elementos da lista pelo espaço entre elas.
